...
# add labels and set theme
zoom_transmission_plot <- zoom_transmission_plot +
  labs(
...
ggsave(filename = "results/zoom_transmission_plot.png", 
       plot = zoom_transmission_plot, width = 8, height = 6)
